    ...
    for DATASET in DATASETS:
        ...
        for result_path in all_simulations:
            ...
            if "atomization" not in result_path:
                ...
                #plt.show()
                #pdb.set_trace()
                ana.plot_pareto(sim_name, hline=gap_constr_val, vline=best_ref_val,dataset=DATASET ,coloring="encounter",plot_quantity =sim_info["quant"] )
                ana.plot_pareto(sim_name, hline=gap_constr_val, vline=best_ref_val,dataset=DATASET ,coloring="density",plot_quantity = sim_info["quant"])
