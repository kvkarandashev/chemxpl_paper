...
for result_path in all_simulations:
    ...
    sim_name = "/data/jan/konstantin_plots/{}_{}_{}_{}_{}".format(sim_info["dataset"],sim_info["quant"],sim_info["gap_constraint"], sim_info["bias_strength"],sim_info["seed"])
    best_ref_val, gap_constr_val = sim_info["best_ref_val"], sim_info["gap_constr_val"]


    ana = Analyze("{}/restart_file*".format(result_path),quanity=sim_info["quant"], verbose=True)
