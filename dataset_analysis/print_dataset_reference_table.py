...
def find_extrema(egcs, mean_or_std, quant_name, find_max):
    ...
    for egc in egcs:
        ...
        if better(val, best_val, find_max):
            ...
            best_val = val
    return format_func(best_val), best_SMILES
...
hmax_RMSE_dipole = "max. $\dipole$, a.u."
hsmax_RMSE_dipole = "max. $\dipole$ SMILES"
...
def main():
    ...
    table = {("dataset", "\cline{2-3} \cline{5-6} $\gap$ constr."): extrema_headers}
