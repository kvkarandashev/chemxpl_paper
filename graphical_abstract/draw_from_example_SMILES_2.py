...
\\newcommand{\\mutarr}[2]{\\draw [blue, arrows={-\\mutarrend{blue}}, line width=0.5mm] (#1) -- (#2)}

\\newcommand{\\steparr}[2]{\\draw [black, arrows={-\\mutarrend{black}}, line width=0.75mm] (#1) -- (#2)}
\\newcommand{\\temparr}[2]{\\draw [red, arrows={\\mutarrend{red}-\\mutarrend{red}}, line width=2.0mm] (#1) -- (#2)}
...
steparr_label_y = steparr_y - 0.75

temparr_x = -0.25
temparr_y_bottom = y_placement
temparr_y_top = -0.25
temparr_label_shift_y = 0.1
temparr_label_shift_x = -0.2
