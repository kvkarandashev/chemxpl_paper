...
\\newcommand{\\temparr}[1]{\\node [shading=temparrshading,
  ...
  minimum height=5.5cm, line width=1.5mm] (temparr) at (#1) {}}
...
\\temparr{"""
    + str(temparr_x)
    + """,-3.25};
\\node[above left = 2.4cm and -1.5cm of temparr] (exploration) {exploration};
\\node[below left = 2.4cm and -1.5cm of temparr] (exploitation) {exploitation};
"""
)
